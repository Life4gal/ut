...
#include <prometheus/ut/dispatcher.hpp>

namespace prometheus::ut
{
	// =========================================
	// OPERANDS
	// =========================================
	...
	[[nodiscard]] inline auto get_config() noexcept -> config_type&
	{
		return executor::Executor::instance().get_config();
	}
	...
	// PROMETHEUS_COMPILER_NO_DESTROY constexpr auto suite = dispatcher::DispatcherSuite<SuiteName>::placeholder();
